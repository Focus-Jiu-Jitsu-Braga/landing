          ...
          >
            ...
            <nav className="mt-6">
              <ul className="-my-2 divide-y divide-zinc-100 text-base text-zinc-800 dark:divide-zinc-100/5 dark:text-zinc-300">
                <MobileNavItem href="/about">Professor</MobileNavItem>
                <MobileNavItem href="/schedule">Horário</MobileNavItem>
                <MobileNavItem href="/team">Equipa</MobileNavItem> 
                <MobileNavItem href="https://pelomundo.jiujitsubraga.com/">Fotos</MobileNavItem>
  ...
  return (
    <nav {...props}>
      <ul className="flex rounded-full bg-white/90 px-3 text-sm font-medium text-zinc-800 shadow-lg shadow-zinc-800/5 ring-1 ring-zinc-900/5 backdrop-blur dark:bg-zinc-800/90 dark:text-zinc-200 dark:ring-white/10">
        <NavItem href="/about">Professor</NavItem>
        <NavItem href="/schedule">Horário</NavItem>
        <NavItem href="/team">Equipa</NavItem>
        <NavItem href="https://pelomundo.jiujitsubraga.com/">Fotos</NavItem>
      </ul>
    </nav>
  )
}
